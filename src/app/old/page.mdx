...
export const metadata = {
  ...
  description:
    'Learn everything there is to know about the GoLogin API and integrate Protocol into your product.',
}
...
Use the GoLogin API to access contacts, conversations, group messages, and more and seamlessly integrate your product into the workflows of dozens of devoted Protocol users. {{ className: 'lead' }}
