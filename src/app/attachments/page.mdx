...
Attachments are how you share things in GoLogin — they allow you to send all sorts of files to your contacts and groups. On this page, we'll dive into the different attachment endpoints you can use to manage attachments programmatically. We'll look at how to query, upload, update, and delete attachments. {{ className: 'lead' }}
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -G https://api.gologin.chat/v1/attachments \
      ...
      "data": [
        {
          ...
          "file_url": "https://assets.gologin.chat/attachments/Invoice_room_service__Plaza_Hotel.pdf",
...
<Row>
  <Col>
    ...
    This endpoint allows you to upload a new attachment to a conversation. See the code examples for how to send the file to the GoLogin API.
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.gologin.chat/v1/attachments \
      -H "Authorization: Bearer {token}" \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://api.gologin.chat/v1/attachments/Nc6yKKMpcxiiFxp6 \
      -H "Authorization: Bearer {token}"
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X PUT https://api.gologin.chat/v1/attachments/Nc6yKKMpcxiiFxp6 \
      -H "Authorization: Bearer {token}" \
    ...
    ```json {{ title: 'Response' }}
    {
      ...
      "message_id": "LoPsJaMcPBuFNjg1",
      "filename": "Invoice_room_service__Plaza_Hotel.pdf",
      "file_url": "https://assets.gologin.chat/attachments/Invoice_room_service__Plaza_Hotel_updated.pdf",
      "file_type": "application/pdf",
      "file_size": 21352,
      "created_at": 692233200
    }
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://api.gologin.chat/v1/attachments/Nc6yKKMpcxiiFxp6 \
      -H "Authorization: Bearer {token}"
    ```
